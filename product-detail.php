...
<body>
  ...
  <main id="main" class="position-relative">
    ...
    <section id="detail-catalog" class="section">
      <div class="container">
        <div class="row px-1 px-lg-0 justify-content-center mt-lg-0">
          <div class="col-12 col-lg-3 text-white d-flex flex-lg-column flex-row align-items-center widget-catalog-detail">
            ...
            <div class="container d-lg-inline d-none px-0">
              ...
              <div class="rounded-bottom w-100 p-2 card-widget-catalog text-xs">

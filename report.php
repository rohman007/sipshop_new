...
<body>
          ...
          <div class="col-12 col-sm-9" style="width:80%">
            <div class="rounded-4 bg-blackgrey text-white py-sm-3 px-sm-4  pb-1">
              <div class="px-md-2 px-3 py-3">
                <h2 class="fw-bold fs-3  mt-2 mt-sm-0">Laporan</h2>
                <p class="fw-500">Menampilkan laporan total penjualan per hari.</p>
              </div>
              ...
              <div class="data-order mb-md-5 mb-4">
                <div class="">
                  <table id="list-order" class="table  text-white text-sm bg-transparent mb-0 rounded-3">
                    ...
                    <tbody>
                      <tr class="fw-500">
                        <td>06-12-23 20:23:11</td>
                        <td class="text-center">Rp. 26.500 </td>
                        <td class="text-center">Rp. 76.500 </td>
                      </tr>
                      <tr class="fw-500">
                        <td>07-12-23 20:23:11</td>
                        <td class="text-center">Rp. 52.000 </td>
                        <td class="text-center">Rp. 90.000 </td>
                      </tr>
                      <tr class="fw-500">
                        <td>08-12-23 20:23:11</td>
                        <td class="text-center">Rp. 45.500 </td>
                        <td class="text-center">Rp. 102.500 </td>
                      </tr>
                    </tbody>
                  </table>
                </div>
  ...
  <script>
    $(document).ready(function() {
      $('#laporan-sidebar').addClass("active");

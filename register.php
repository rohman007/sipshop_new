...
<body id="login-page">
  ...
  <div class="d-flex vh-100 align-items-center">
    <div class="form-block px-3 ps-md-5 col-12 col-sm-6 col-md-4">
      ...
      <p class="text-white fw-500 mb-4 text-sm">Daftar akun sipshop dengan mengisi form dibawah</p>
      <form action="">  
        ...
        <div class="form-group mb-3 position-relative">
            <input id="password-field" type="password" class="form-control" name="repassword" placeholder="Konfirmasi Password" required="">
            <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
        </div>
        <button class="btn btn-primary btn-sm w-100 mb-3" type="submit"><strong>Daftar Sekarang</strong></button>
        <p class="mb-2 text-center text-white">Sudah punya akun? <a href="login.php" class="ms-2">Masuk Sekarang</a></p>
      </form>
    </div>

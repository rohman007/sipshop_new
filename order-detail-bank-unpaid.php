          ...
          <div class="col-12 col-sm-9" style="width:80%">
            <div class="rounded-4 bg-blackgrey text-white py-md-4 py-3 px-3 px-sm-5 pb-5">
              ...
              <div class="d-sm-none">
                ...
                <div class="fs-6 rounded-3 bg-red text-white mb-2 mx-3 fw-bold mt-3 py-2 text-center">2 jam, 30 menit, 1 detik</div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="row align-items-center">
                    <div class="col-5 col-sm-5 fw-500 text-sm">Mandiri Virtual Account</div>
                    <div class="col-7 col-sm-7"><div class="px-2 fw-bold py-1 bg-grey text-white rounded-3 d-inline-block">8839384827387478 <i class="fa fa-file-o ms-1" aria-hidden="true"></i></div></div>
                  </div>
